...
const STEPS = [
  {
    ...
    desc: 'Chama no WhatsApp ou preenche o formulário aqui do site com marca, modelo e o que está acontecendo. A gente responde em minutos.',
    time: 'Resposta em até 2 min',
  },
  {
    num: '02',
    icon: FileText,
    title: 'Avaliação e valor',
    desc: 'A gente analisa seu aparelho e passa um valor claro, sem custo e sem compromisso. Se fizer sentido para você, seguimos. Se não fizer, tudo bem.',
    time: 'Avaliação gratuita',
  },
  {
    num: '03',
    icon: CheckCircle,
    title: 'Tudo pronto',
    desc: 'Pedidos mais comuns ficam prontos em algumas horas. Situações mais delicadas podem levar mais tempo, e você acompanha cada etapa.',
    time: 'Maioria pronta em até 4h',
  },
]
